...
exports.getOneProduct = exports.getAllProducts = exports.createProduct = void 0;
...
var createProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var newProduct, resault, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                newProduct = new product_model_1.default(__assign({}, req.body));
...
var getOneProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, product_model_1.default.findById(ObjectId(req.params.id))];
            case 1:
                product = _a.sent();
                console.log(product);
                if (!product)
